...
import 'package:foodorder_app/screens/check-out/payment/repo/payment_needed.dart';
...
class _HomeZaloPayState extends State<HomeZaloPay> {
  ...
  final valueStyle = TextStyle(
      color: primaryColor, fontSize: 18.0, fontWeight: FontWeight.w400);
  String zpTransToken = "";
  String payResult = "";
          ...
          onTap: () async {
            ...
            if (amount < 1000 || amount > 1000000) {
              ...
              if (result != null) {
                ...
                zpTransToken = result.zptranstoken.toString();
      ...
      Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text("Nhập số tiền cần thanh toán"),
          ),
        ],
      ),
      // _btnQuickEdit,
